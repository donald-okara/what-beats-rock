...
class ProfileRepositoryImpl(
    ...
    override suspend fun fetchProfile(id: String): Result<PodiumProfile> = api.getPodiumProfileById(id)
    override suspend fun fetchMyProfile(): Result<PodiumProfile> = api.getMyPodiumProfile()
